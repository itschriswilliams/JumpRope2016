<!-- Intro Banner -->
<section class="intro classroom-solutions">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 text-left">
                    ...
                    <br>
                    <br>
                    <h4 class="questrial turq-text uppercase margined-bottom tiny">Classroom Solutions</h4>
                    <h2 class="nomargin">
...
<section class="solutions padded">
    <div class="container">

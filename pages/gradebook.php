        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 text-left">
                    ...
                    <p class="white-text">JumpRope’s software is designed to work in all different learning environments. This flexibility allows your district to tailor our gradebook to your specific philosophy, standards, and language.</p>
            </div>
        </div>
    </div>
</div>
...
<section class="gradebook-details padded">
    <div class="container">
        <div class="row text-center padded-bottom less">
            <div class="col-sml-10 col-sm1-offset-1 center">
                <h2>JumpRope can fit into your language and philosophy</h2>
                <p class="ltgrey-text">We recognize the process of measuring student proficiency goes by a variety of different names. Standards, competency, proficiency, mastery-based… our gradebook will work with your grading philosophy. We understand each philosophy’s nuances and support your district’s goal to measure student progress by well-defined learning objectives.</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-4 text-center">
                <img src="//placehold.it/90x90" alt="">
                <br><br>
                <h4>Course and Profciency Transcripts</h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 padded tiny">
                <a href="#"><h6 class="uppercase white-text right"><img src="//placehold.it/64x64" alt="">Learn About The Curriculum Planning Tool</h6></a>
            </div>
        </div>        
    </div>
</section>
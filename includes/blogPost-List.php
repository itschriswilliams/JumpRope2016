<!-- Blog Post - List View -->
<article class="blogPost-ListItem container">
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1 margined-top">
            <article>
                <div class="row">
                    <div class="col-sm-5">
                        <a href="#">
                    ...
                    <div class="col-sm-7 text-left">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tincidunt sem tristique velit varius, quis...</p>
                        <p class="smaller"><a href="#" class="uppercase blue-text">Keep Reading +</a></p>
                    </div>
                </div>
            </article>
        </div>
